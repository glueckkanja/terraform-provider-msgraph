...
Interested in the provider's latest features, or want to make sure you're up to date? Check out the [changelog](https://github.com/glueckkanja/terraform-provider-msgraph/blob/main/CHANGELOG.md) for version information and release notes.
